...
A simple input/output machine process using a paper ball as data and pipes as the network with weight fluctuation and adjustment was explored; The napkin idea — gave way to explore patterns with the lens of order and chaos
...
Imagining the inside of a Black-box by stacking layers horizontally- let children play with input-output pipelines
...
What is intelligence? The Oxford Dictionary defines Intelligence as the ability to acquire and apply knowledge and skills.
...
One of the pictures from visual notes shows categories when we were exploring physical embodiment for learning.
...
Notes from conceptualizing the high-level structure of toolkit
...
Sigmoid Concept juxtaposed on K-12 curriculum
