...
1. New shapes - Logarithmic spiral, Polygon, Superellipse and Astroid
2. Added about page and image hints for each shape.
3. Minor UI improvements to make it easier to use Geometric.
